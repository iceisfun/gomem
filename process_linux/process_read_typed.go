...
func (p *LinuxProcess) ReadBlobsX(list []process.ProcessMemoryAddress, size process.ProcessMemorySize) []process.ReadBlobsResult {
	if len(list) == 0 {
...
func (p *LinuxProcess) ReadBlobs(list []process.ProcessMemoryAddress, blobReadSize process.ProcessMemorySize) []process.ReadBlobsResult {
	if len(list) == 0 {
		return []process.ReadBlobsResult{}
	}
	if blobReadSize == 0 {
